...
const events = [
  { id: 1, name: 'Ongoing Events', details: ongoingEvents },
  { id: 2, name: 'Upcoming Events', details: upcomingEvents },
  { id: 3, name: 'Past Events', details: pastEvents },
  { id: 4, name: 'Download', details: downloadDetails }
];
                ...
                {selectedMonth && (
                  <div className="event-cards ">
                    {upcomingEvents
                      ...
                      .events.map(event => (
                        <div className='display-flex upcomming-event-cards element-style'>
